...
using ShoppApp.WebApp.Validators;

namespace ShoppApp.WebApp.Controllers
{
    [Authorize(Roles ="admin")] // Admin Controllera ulaşmak isteyince yetkilendirilmiş bir kullanıcı olması gerekiyor
    public class AdminController : Controller
    {
        ...
        public IActionResult ProductCreate(ProductModel model)
        {
            ...
            //        Message = $"{entity.Name} aynı isimle iki ürün eklenemez",
            //        AlertType = "danger"
            //    });
            //}
            //else
